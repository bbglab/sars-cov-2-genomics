...
#python script to generate N simulations of X SYN mutations along the genome and compare them with the observed # of SYN mutations. Input parameters are the tab-delimited file from the snakemake pipeline and and the chunk_size.
#by default, the min and max AF are 0.01 and 0.5 respectively. 

#python inter_simulate.py input output chunk_size
#python src_analysis/mutrate_simulate.py output_example/allmuta_annot.vcf k5000.csv 5000
